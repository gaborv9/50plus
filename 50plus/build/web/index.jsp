    ...
    <body>
        ...
        <form class="form-signin" method="post" action="Register" role="form">
            ...
            <div class="form-group">
                ...
                <input type="nutzername" class="form-control" name="nutzername" placeholder="Nutzername" required>
            </div>
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox"> Sie erklären sich hiermit einverstanden, dass alle ihre Daten zu Forschungszwecken weitergeleitet werden, have fun.
                </label>
            </div>
